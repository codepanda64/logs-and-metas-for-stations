    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='instrument_models', to='instruments.InstrumentCategory', verbose_name='所属分类')),
            ],
            options={
                'verbose_name': '设备信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrument_model', models.ForeignKey(limit_choices_to={'has_sn': True}, on_delete=django.db.models.deletion.CASCADE, related_name='instrument_entities', to='instruments.InstrumentModel', verbose_name='设备型号')),
            ],
            options={
                'verbose_name': '测震设备实体',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrument', models.ForeignKey(limit_choices_to={'has_sn': False}, on_delete=django.db.models.deletion.CASCADE, to='instruments.InstrumentModel', verbose_name='仪器型号')),
